...
ALLOWED_HOSTS = ['chords-theory-back.herokuapp.com', 'localhost', '127.0.0.1']
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://chords-theory-back.herokuapp.com/chordstheory?user=admin&password=admin',
        conn_max_age=600,
